...
(function($) {
    ...
    var password_Strength = new function() {
        ...
        this.getStrengthInfo = function(passwordVal) {
            ...
            if ((specials + uppers + nums + lowers) < password_settings.minLength) {
                msg += password_settings.minLength - passwordVal.length + " more characters, ";
            }
    ...
    $.fn.password_strength = function(options) {
        ...
        $.ajax({
            type: "GET",
            url: "", //use absolute link if possible
            dataType: "xml",
        ...
        return this.each(function() {
            ...
            .css({ color:'#ccc', display: 'none' })
            .eq(0).css({ height: 3, top: barTopPos - 36, left: barLeftPos + 55, 'border-style': 'solid', 'border-width': 1, padding: 2 }).end()
            .eq(1).css({ height: 5, top: barTopPos - 34, left: barLeftPos + 88 }).end()

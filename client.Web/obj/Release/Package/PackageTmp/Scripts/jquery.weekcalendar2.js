      ...
      */
      ...
      _renderCalendar : function() {
        ...
        // calendarBodyHtml += "</div></div></td></tr><tr><td class=\"wc-grid-timeslot-header\">";
         calendarBodyHtml += "</div></div></td></tr><tr>";
         calendarBodyHtml += "<td class=\"wc-grid-timeslot-header\">";
      ...
      // _setTimeSlots : function($weekDay) {
//             var self = this;
//             var options = this.options;
//             alert($weekDay.data("startDate").getTime());
//             var $calEvent = $weekDay.element;
//             var top = Math.round(parseInt($weekDay.position.top));
//             var eventDuration = self._getEventDurationFromPositionedEventElement($weekDay, $calEvent, top);
//             alert(eventDuration.start);
//       },
